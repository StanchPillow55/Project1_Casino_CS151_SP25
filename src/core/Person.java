...
public class Person{
    ...
    public Person(String name){
        ...
        inebriation = 0; //+1 for every drink, all drinks assumed to be standard, 6+ = kicked out
    ...
    public void countInstances() throws InstanceOverload{
       if(instances > 100){
        System.out.println("Too many instances of Person.");
        System.exit(0);
       }
    }

    public void checkNetEarnings() {
        if (this.getNetEarnings() > 1000000) {
